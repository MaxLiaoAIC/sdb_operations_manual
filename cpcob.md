# SOAP Webservice方式呼叫SECP進行AESKey解密
### service url =  https://172.24.30.173:9443/secp-web/services/cryptoService
##### 上行電文
``` xml
...
# ESB(JMS)進行身份驗證
### request queue = CTCB.ESB.SIT.Public.Service.Request.C01.CH1
### response queue = CTCB.ESB.SIT.Public.Service.Reply.TWMPB
##### 上行電文
```xml
<?xml version="1.0" encoding="UTF-8"?>
...
# form data post xml format String 發送OTP密碼
### 
##### 上行電文
```xml
<?xml version="1.0" encoding="UTF-8"?>
<SecurityProvider xmlns="http://insp.chinatrust.com.tw" xmlns:ns2="http://insp.chinatrust.com.tw/ws/CryptoService">
   ...
   <Body>
      ...
      <Method>genOTP</Method>
      <TransID>OTP0001</TransID>
      <PhoneNO>0932219769</PhoneNO>
